...
// --- SessionKeys type alias ---
pub type SessionKeys = opaque::SessionKeys;

// --- Implement pallet_session::Config ---
impl pallet_session::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
	type ValidatorId = <Self as frame_system::Config>::AccountId;
	type ValidatorIdOf = pallet_staking::StashOf<Self>;
	type ShouldEndSession = pallet_session::PeriodicSessions<ConstU32<1>, ConstU32<1>>;
	type NextSessionRotation = pallet_session::PeriodicSessions<ConstU32<1>, ConstU32<1>>;
...
// --- Implement pallet_staking::Config ---
...
// --- Implement pallet_authorship::Config ---
...
impl pallet_staking::BenchmarkingConfig for StakingBenchmarkingConfig {
	type MaxValidators = StakingMaxValidators;
	type MaxNominators = StakingMaxNominators;
}

// --- Define the staking reward curve as a static ---
pub static REWARD_CURVE: PiecewiseLinear<'static> = PiecewiseLinear {
	points: &[
		(Perbill::from_percent(0), Perbill::from_percent(2)),
...
parameter_types! {
	pub StakingRewardCurve: &'static PiecewiseLinear<'static> = &REWARD_CURVE;
}
